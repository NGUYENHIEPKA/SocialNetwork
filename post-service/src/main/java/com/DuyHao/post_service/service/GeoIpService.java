...
public class GeoIpService {
	...
	public String resolveCity(String ip) {
		...
		CompletableFuture<String> geoLiteFuture = CompletableFuture
				.supplyAsync(() -> resolveFromGeoLite2(resolvedIp));

		CompletableFuture<String> ipinfoFuture = CompletableFuture
				.supplyAsync(() -> resolveFromIpInfo(resolvedIp));

		String geoLiteResult = geoLiteFuture.join();
		String ipinfoResult = ipinfoFuture.join();

		log.info("IP={} | GeoLite2={} | IPinfo={} | Final={}",
				resolvedIp, geoLiteResult, ipinfoResult,
